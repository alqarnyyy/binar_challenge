      ...
      <div className="container" style={{ marginTop: "70px" }}>
        <div className="row">
          <div className="col-lg-6 col-xs-12">
            <img src="img/cewek1.png" style={{ alignItems: "center" }} className="img-fluid" width={374} height={562} />
          </div>
          <div className="col-lg-6 col-xs-12">
            ...
            <p className="list">
              ...
              &nbsp;&nbsp;Sewa mobil dengan supir di Jogja 12 Jam
            </p>
            <p className="list">
              <img src="img/checklist.png" width={20} height={20} />
              &nbsp;&nbsp;Sewa mobil lepas kunci di Jogja 24 Jam
            </p>
            <p className="list">
              <img src="img/checklist.png" width={20} height={20} />
            ...
            <p className="list">
              <img src="img/checklist.png" width={20} height={20} />
              &nbsp;&nbsp;Gratis Antar - Jemput Mobil di Bandara YIA
            </p>
            <p className="list">
              <img src="img/checklist.png" width={20} height={20} />
